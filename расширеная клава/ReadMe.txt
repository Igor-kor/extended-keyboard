========================================================================
    ПРИЛОЖЕНИЕ : Обзор проекта расширеная клава
========================================================================

Это приложение расширеная клава создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения расширеная клава.

расширеная клава.vcxproj
...
расширеная клава.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем расширеная клава.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
